...
var KTAffiliateUsersUpdateDetails = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_update_affiliate_user');
    const form = element.querySelector('#kt_modal_update_affiliate_user_form');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        var UserformData = $('#kt_modal_update_affiliate_user_form').serialize();
