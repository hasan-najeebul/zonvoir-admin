"use strict";
var KTSellerDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_table_seller_list').attr('data-table-url');
        dt = $("#kt_table_seller_list").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[1, 'desc']],
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.seller_tab').on('click',function(){
        KTSellerDatatablesServerSide.init();
    // })
