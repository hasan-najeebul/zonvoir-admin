"use strict";
var KTProjectManagerDatatables = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_table_project_manager').attr('data-table-url');
        dt = $("#kt_table_project_manager").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[1, 'desc']],
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.project_manager_tab').on('click',function(){
        KTProjectManagerDatatables.init();
    // })
