"use strict";
var KTProformaDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_table_partner_proforma').attr('data-table-url');
        dt = $("#kt_table_partner_proforma").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[1, 'desc']],
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.proforma_tab').on('click',function(){
        KTProformaDatatablesServerSide.init();
    // })
