"use strict";
var KTInvoiceDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_table_partner_invoices').attr('data-table-url');
        dt = $("#kt_table_partner_invoices").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[1, 'desc']],
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.invoice_tab').on('click',function(){
        KTInvoiceDatatablesServerSide.init();
    // })
});
