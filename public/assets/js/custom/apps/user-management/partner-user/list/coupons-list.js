"use strict";
var KTCouponDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_table_partner_store_coupons').attr('data-table-url');
        dt = $("#kt_table_partner_store_coupons").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[1, 'desc']],
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.coupons_tab').on('click',function(){
        KTCouponDatatablesServerSide.init();
    // })
});
