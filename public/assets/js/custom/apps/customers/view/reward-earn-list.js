"use strict";
var KTRewardDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterRoles;
    ...
    var initDatatable = function () {
        var urls = $('#kt_customer_view_reward_earn_list').attr('data-table-url');
        dt = $("#kt_customer_view_reward_earn_list").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[3, 'desc']],
            initComplete:function(settings, json) {
                $('#kt_customer_view_reward_earn_list tbody tr td').eq(1).addClass('text-success');
            },
            ajax: {
                url: urls,
                data:function(d) {
...
KTUtil.onDOMContentLoaded(function () {
    // jQuery('.invoice_tab').on('click',function(){
        KTRewardDatatablesServerSide.init();
    // })
});
