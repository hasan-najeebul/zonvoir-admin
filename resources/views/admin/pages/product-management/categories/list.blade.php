...
@section('content')
<!--begin::Container-->
<div id="kt_content_container" class="container-xxl" url="{{ route('product-management.category.index') }}">
    <!--begin::Category-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-150px">{{__('messages.created_by')}}</th>
                        <th class="min-w-150px">{{__('messages.date_created')}}</th>
