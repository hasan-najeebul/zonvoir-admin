    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{ __('messages.update_permission')}}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        ...
                        <div class="fw-bold">
                            ...
                            <strong class="me-1">{{ __('messages.warning')}}</strong>{{ __('messages.permission_edit_warning_message')}}</div>
                        </div>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                ...
                <form id="kt_modal_update_permission_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Enter a permission name" id="permission_name" name="name" value="">
