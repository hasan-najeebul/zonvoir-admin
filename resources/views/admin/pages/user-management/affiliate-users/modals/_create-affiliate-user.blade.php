<div class="modal fade" id="kt_modal_add_affiliate_user" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <!--begin::Form-->
            <form class="form" action="{{ route('user-management.affiliate.store')}}" id="kt_modal_add_affiliate_user_form">
                <!--begin::Modal header-->
                @csrf
                @method('POST')
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_affiliate_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_affiliate_user_header" data-kt-scroll-wrappers="#kt_modal_add_affiliate_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold mb-2">{{__('messages.full_name')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="row g-9 mb-7">
                            <div class="col-md-6 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="email" class="form-control form-control-solid" autocomplete="off" placeholder="" name="email" value="" />
                                <!--end::Input-->
                            </div>
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" class="form-control form-control-solid" placeholder="" name="mobile_number" value="" placeholder="00254578" />
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="row g-9 mb-7">
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                    <span class="required">{{__('messages.password')}}</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email address must be active"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="password" class="form-control form-control-solid" placeholder="" name="password" value=""  placeholder="********"/>
                                <!--end::Input-->
                            </div>
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                    <span class="required">{{__('messages.confirm_password')}}</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="mobile number must be active"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="password" class="form-control form-control-solid" placeholder="" name="password_confirmation" value="" placeholder="********">
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="10" name="commission" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                        ...
                        <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_add_affiliate_user_info" role="button" aria-expanded="false" aria-controls="kt_affiliate_user_view_details">{{__('messages.address_information')}}
                            ...
                            <div id="kt_modal_add_affiliate_user_info" class="collapse show">
                                ...
                                <div class="row g-9 mb-7">
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="street" value="{{ old('street') ?? ''}}" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="house_no" value="" placeholder="House No.">
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="city" value=""  placeholder="Melbourne">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="postal_code" value="" placeholder="00255">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                            ...
                            <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_add_affiliate_bank_info" role="button" aria-expanded="false" aria-controls="kt_affiliate_user_view_details">{{ __('messages.bank_information')}}
                                <span class="ms-2 rotate-180">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <div id="kt_modal_add_affiliate_bank_info" class="collapse show">
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="account_number" value="" placeholder="54545454545   ">
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                </div>
