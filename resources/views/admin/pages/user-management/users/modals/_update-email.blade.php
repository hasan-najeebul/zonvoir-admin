    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{ __('messages.update_email_address')}}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_update_email_form" class="form" action="{{ route('user-management.users.updateEmail',$user->id)}}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            <!--begin::Content-->
                            <div class="fw-bold">
                                <div class="fs-6 text-gray-700">{{ __('messages.update_email_info')}}</div>
                            </div>
                            <!--end::Content-->
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <label class="fs-6 fw-bold form-label mb-2">
                            <span class="required">{{ __('messages.email_address')}}</span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
