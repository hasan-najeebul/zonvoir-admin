        ...
        <div class="page d-flex flex-row flex-column-fluid">
                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 me-2">
                                    ...
                                    <!--begin::Description-->
                                    <span
                                        class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ auth()->user()->roles->first()->name ?? '' }}</span>
                                    <!--end::Description-->
                                    <!--begin::Label-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header align-items-stretch">
                    ...
                    <div class="toolbar d-flex align-items-stretch">
                        ...
                        <div
                            ...
                            @include('layouts.partials.header-layout.header.right-menu')
                            <!--end::Page title-->
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <!--begin::Post-->
                    @if ($errors->has('AccessDenied'))
                        <script>
                            document.addEventListener("DOMContentLoaded", function(event) {
                                toastr.error('{{ $errors->first('AccessDenied') }}');
                            })
                        </script>
                    @endif
                    {{-- @if ($errors->has('AccessDenied'))
                        <div class="alert alert-danger">
                            {{ $errors->first('AccessDenied') }}
                        </div>
                    @endif --}}
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://zonvoir.com" target="_blank"
                                class="text-gray-800 text-hover-primary">Zonvoir</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
